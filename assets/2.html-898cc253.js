import{_ as u,X as m,Y as b,Z as e,$ as s,a0 as r,a2 as n,a3 as t,F as o}from"./framework-c8dc88ca.js";const v={},p=t(`<h1 id="macos简单配置" tabindex="-1"><a class="header-anchor" href="#macos简单配置" aria-hidden="true">#</a> macos简单配置</h1><h2 id="_1-解锁系统偏好设置" tabindex="-1"><a class="header-anchor" href="#_1-解锁系统偏好设置" aria-hidden="true">#</a> 1.解锁系统偏好设置</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> spctl --master-disable
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,3),h={id:"_2-安装iterm2-官网下载",tabindex:"-1"},g=e("a",{class:"header-anchor",href:"#_2-安装iterm2-官网下载","aria-hidden":"true"},"#",-1),k={href:"https://iterm2.com/downloads.html",target:"_blank",rel:"noopener noreferrer"},w=t(`<p><img src="http://img.brinish.eu.org:5205/images/2023/04/16/aa859c809e85a064491349e5ed4491e6.png" alt="下载iterm2" loading="lazy"></p><h2 id="_3-安装brew" tabindex="-1"><a class="header-anchor" href="#_3-安装brew" aria-hidden="true">#</a> 3.安装brew</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>/bin/bash <span class="token parameter variable">-c</span> <span class="token string">&quot;<span class="token variable"><span class="token variable">$(</span><span class="token function">curl</span> <span class="token parameter variable">-fsSL</span> https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh<span class="token variable">)</span></span>&quot;</span>
